...
/**
 * BluetoothSpp内部用到的蓝牙处理类
 * 内部获取了BluetoothAdapter，维护mConnectThread，mConnectedThread两个handler，负责连接等操作
 */
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != BluetoothState.STATE_CONNECTED && isRunning) {
                try {
                    Log.e("bluetooth", "accept");
                    if (mmServerSocket != null) {
                        socket = mmServerSocket.accept();
                    } else {
                        Log.e("BluetoothService ", "mmServerSocket为null");
                        break;
                    }
                } catch (IOException e) {
                    break;
                    ...
                    synchronized (BluetoothService.this) {
                        switch (mState) {
                            ...
                            case BluetoothState.STATE_CONNECTING:
                                Log.e("bluetooth", "STATE_CONNECTING");
                                // Situation normal. Start the connected thread.
                                connected(socket, socket.getRemoteDevice(),
                                        mSocketType);
                                break;
                            case BluetoothState.STATE_NONE:
                                Log.e("bluetooth", "STATE_NONE");
                            case BluetoothState.STATE_CONNECTED:
                                Log.e("bluetooth", "STATE_CONNECTED");
