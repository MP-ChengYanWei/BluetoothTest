package com.mpen.bluetooth.bean;
 ...
 */
public class CacheBookModel implements Serializable {
    public CacheBookModel() {
    }
    ...
    public CacheBookModel modelWithData(Object data) {
        CacheBookModel model = new CacheBookModel();
        try {
    ...
    //测试添加数据使用
    public CacheBookModel(int str1, String str2, int str3, int str4, String str5, String str6, String str7) {
        this.progress = str1;
        this.status = str2;
