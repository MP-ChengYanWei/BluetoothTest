...
/**
 * Created by wutingyou on 2017/1/19.
 * 参考了网上的代码
 * https://github.com/ALLENnan/VolleyManager/\
 * blob/92774222e8f270f2908d8e83e015cc097391db0f/\
 * app/src/main/java/com/example/allen/volleymanager/volley/OkHttp3Stack.java
 */
    ...
    public HttpResponse performRequest(Request<?> request, Map<String, String> additionalHeaders)
        ...
        for (int i = 0, len = responseHeaders.size(); i < len; i++) {
            ...
            if (name != null) {
                ...
                Log.d("ohttp", "okHttp name: " + name + " value " + value);
                if (value.contains("ucenterKey")) {
//                    SPUtils.put(SPUtils.COOKIE_UCENTERKEY, value);
                }
            }
        }
        return response;
